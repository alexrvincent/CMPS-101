/* Programmers: Alex Vincent (avincent@ucsc.edu)
	...
	This program is the implementation file for the List.h
	file. See the header file for a breakdown of the capabilities
	and list of all the methods for this of the ADT. Note, the is
	a printListFile method that is not used, but was rather implemented
	for debugging sake, and has now been commented out. No further
	information needed
*/
