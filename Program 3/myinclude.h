/*Header file created by David Helmbold, used in this assignment. We, Alex Vincent
 * and Nader Sleem did not create this, but were given permission to use it
 * Last Edited : By David Helmbold*/
